    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-12">
      ...
      <div className="printable-area max-w-4xl mx-auto bg-white text-black p-8 sm:p-12 rounded-lg shadow-lg">
        ...
        <div className="text-xs text-gray-500 font-mono border-t-2 border-black pt-4">
          ...
          <p>This report was generated by Card Scout on {today}. Values shown are based on recent eBay sold comparables and are estimates only. Consult a certified appraiser for formal insurance purposes.</p>
        </div>
      </div>
    </div>
  );
